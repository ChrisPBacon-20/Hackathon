...
# Parametersuche
price_low_values = np.arange(0.02, 0.04, 0.005) # verschiedene min und max preise testen um den sweet spot für Autarkie und Gewinn zu finden
price_high_values = np.arange(0.02, 0.04, 0.005) # in dieser Datei ist dieser schritt stark heruntergebrochen, damit es schneller geht
